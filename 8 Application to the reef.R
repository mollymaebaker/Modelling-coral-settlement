### 8. Applying the model to a case study site - 

### uploading the mosaic png into R and assigning different substrate types
### assigning different settlement probabilities
### saving as a submat for simulation
### this will have to be carefully adapted for any new png
